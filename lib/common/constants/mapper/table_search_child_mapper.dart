...
import 'package:clean_arch/view/widget/table/table_search/table_data_picker.dart';
...
List<SearchChild> guideSearchChildList = [
  SearchChild(
    columnName: "운영사 이름",
    child: TableSearchBar<ServiceProvider>(
      memberName: "name",
...
List<SearchChild> eventSearchChildList = [
  SearchChild(
    columnName: "운영사 이름",
    child: TableSearchBar<ServiceProvider>(
      memberName: "name",
...
List<SearchChild> noticeSearchChildList = [
  SearchChild(
    columnName: "운영사 이름",
    child: TableSearchBar<ServiceProvider>(
      memberName: "name",
...
Map<String, List<SearchChild>> searchChildMapper = {
  ...
  "Guide": guideSearchChildList,
  "Notice": noticeSearchChildList,
  "Event": eventSearchChildList
};
