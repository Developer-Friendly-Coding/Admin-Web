...
class _GuidePageState extends State<GuidePage> {
  ...
  final String tableName = tableNameMapper['Guide']!;
  @override
  void initState() {
    super.initState();
  }
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Align(
                                      ...
                                      child: TableSearchContainer<Guide>()),
                                          ...
                                          Expanded(
                                            child: Container(
                                              child: Row(
                                                ...
                                                children: [
                                                  TableCreateButton<Guide>(),
                                                  SizedBox(width: 15),
                                                  TableDeleteButton<Guide>(),
                                                  SizedBox(width: 32)
                                                ],
                                              ),
                                            ),
