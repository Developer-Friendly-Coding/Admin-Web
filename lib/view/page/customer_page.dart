...
class _CustomerPageState extends State<CustomerPage> {
  ...
  final String tableName = tableNameMapper['Customer']!;
  @override
  void initState() {
    super.initState();
  }
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Align(
                                      ...
                                      child: TableSearchContainer<Customer>()),
                                          ...
                                          Expanded(
                                            child: Container(
                                              child: Row(
                                                ...
                                                children: [
                                                  TableCreateButton<Customer>(),
                                                  SizedBox(width: 15),
                                                  TableDeleteButton<Customer>(),
                                                  SizedBox(width: 32)
                                                ],
                                              ),
                                            ),
