...
class _NoticePageState extends State<NoticePage> {
  ...
  final String tableName = tableNameMapper['Notice']!;
  @override
  void initState() {
    super.initState();
  }
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Align(
                                      ...
                                      child: TableSearchContainer<Notice>()),
                                          ...
                                          Expanded(
                                            child: Container(
                                              child: Row(
                                                ...
                                                children: [
                                                  TableCreateButton<Notice>(),
                                                  SizedBox(width: 15),
                                                  TableDeleteButton<Notice>(),
                                                  SizedBox(width: 32)
                                                ],
                                              ),
                                            ),
