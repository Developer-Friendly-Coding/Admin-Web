...
class _ManagerPageState extends State<ManagerPage> {
  ...
  final String tableName = tableNameMapper['Manager']!;
  @override
  void initState() {
    super.initState();
  }
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Align(
                                      ...
                                      child: TableSearchContainer<Manager>()),
                                          ...
                                          Expanded(
                                            child: Container(
                                              child: Row(
                                                ...
                                                children: [
                                                  TableCreateButton<Manager>(),
                                                  SizedBox(width: 15),
                                                  TableDeleteButton<Manager>(),
                                                  SizedBox(width: 32)
                                                ],
                                              ),
                                            ),
