...
class RelatedContainer<M extends Base> extends StatefulWidget {
  ...
  @override
  State<RelatedContainer> createState() => _RelatedContainerState();
}

class _RelatedContainerState<M> extends State<RelatedContainer> {
